(function() {
  ...
  Model = (function(_super) {
    ...
    Model.select = function(function_or_attrs) {
      if (typeof function_or_attrs === 'function') {
        return this.selectByFunction(function_or_attrs);
      } else if (typeof function_or_attrs === 'object') {
        return this.selectByAttributes(function_or_attrs);
      } else {
        throw 'Expected function or an object';
      }
    };

    Model.selectByFunction = function(callback) {
    ...
    Model.selectByAttributes = function(attributes) {
      return this.selectByFunction(function(record) {
        var name, value;
